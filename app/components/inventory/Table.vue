  ...
  <div class="space-y-4">
    ...
    >
      ...
      <div class="p-4 overflow-x-auto">
        <!-- Days Header -->
        <div class="grid grid-cols-8 gap-4 mb-4 min-w-[600px]">
        ...
        <!-- Entrées -->
        <div class="grid grid-cols-8 gap-4 py-2 border-b border-gray-100 dark:border-gray-800 min-w-[600px]">
        ...
        <!-- Ventes -->
        <div class="grid grid-cols-8 gap-4 py-3 bg-primary-50 dark:bg-primary-950/30 rounded-lg mt-2 min-w-[600px]">
        ...
        <!-- Stock Final -->
        <div class="grid grid-cols-8 gap-4 py-2 mt-2 min-w-[600px]">
