<template>
  <UDashboardPanel>
    <template #header>
      <CustomDashboardNav title="Details Transformations" />
    </template>
    ...
    <template #body>
      <div class="w-full">
        ...
        <!-- Content -->
        <div
          v-else-if="transformation && !loading"
          class="w-full lg:w-1/2 lg:mx-auto px-4 flex flex-col items-center justify-between gap-4 mt-4"
        >
          <!-- HEADER -->
